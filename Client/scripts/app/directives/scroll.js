  ...
  angular.module('chatModule').directive('ngScrollbar', [
        '$parse',
        '$window',
                ...
                link: function (scope, element, attrs) {
                    ...
                    var buildScrollbar = function (rollToBottom) {
                        ...
                        if (page.height < page.scrollHeight) {
                            ...
                            transculdedContainer.attr('style', 'position:relative;bottom:0');
                    ...
                    if (attrs.hasOwnProperty('rebuildOnChange')) {
                        scope.$watch(rebuild);
                    }
                },
