    ...
    SockJS = function () {
        ...
        f.prototype.emit = function (a) {
            ...
            if (a in b._listeners)
                for (var d = 0; d < b._listeners[a].length; d++) b._listeners[a][d].apply(b, c)
        ...
        var i = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
            ...
            l, m = JSON && JSON.stringify || function (a) {
        ...
        u.prototype = new f(["chunk", "finish"]), u.prototype._start = function (a, d, e, f) {
            ...
            if (f && f.headers)
                for (var j in f.headers) g.xhr.setRequestHeader(j, f.headers[j]);
        ...
        y.prototype = new d, y.version = "--minify", y.CONNECTING = 0, y.OPEN = 1, y.CLOSING = 2, y.CLOSED = 3, y.prototype._debug = function () {
